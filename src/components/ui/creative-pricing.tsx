    ...
    return (
        <div className="w-full max-w-6xl mx-auto px-4">
            <div className="text-center space-y-6 mb-16">
                <div className="font-handwritten text-xl text-[#D3AF37] rotate-[-1deg]">
                    {tag}
                </div>
                <div className="relative">
                    <h2 className="text-4xl md:text-5xl font-bold font-handwritten text-[#650304] dark:text-white rotate-[-1deg]">
                        {title}
                        <div className="absolute -right-12 top-0 text-[#D3AF37] rotate-12">
                            ✨
                        </div>
                        <div className="absolute -left-8 bottom-0 text-[#650304] -rotate-12">
                            ⭐️
                        </div>
                    </h2>
                    <div
                        className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-44 h-3 bg-[#D3AF37]/20 
                ...
                {tiers.map((tier, index) => (
                    ...
                    >
                        ...
                        <div className="relative p-6">
                            {tier.popular && (
                                <div
                                    className="absolute -top-2 -right-2 bg-[#D3AF37] text-zinc-900 
